...
plt.xlabel("x(AU)")
plt.ylabel("y(AU)")
plt.title("Exercise 4.16 3-body simulation (sun) M_J="+strtimes+"M_J0")
plt.scatter(csx1,csy1,label="Sun",color= "red")
plt.plot(cex1,cey1,label="Earth",color ="blue")
plt.plot(cjx1,cjy1,label="Jupiter",color ="brown")
plt.legend()
